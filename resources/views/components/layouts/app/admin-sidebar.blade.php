    ...
    <flux:sidebar sticky stashable class="border-r border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navlist variant="outline">
            <flux:navlist.group :heading="__('Platform')" class="grid">
                ...
                <flux:navlist.item icon="user" :href="route('admin.tenant.list')"
                    :current="request()->routeIs('admin.tenant.list')" wire:navigate>{{ __('Tenants Management') }}
                </flux:navlist.item>
                <flux:navlist.item icon="users" :href="route('admin.user.list')"
                    :current="request()->routeIs('admin.user.list')" wire:navigate>{{ __('Users Management') }}
                </flux:navlist.item>
