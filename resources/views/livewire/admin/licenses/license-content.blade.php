                        ...
                        <table class="w-full text-sm text-left">
                            ...
                            <tbody>
                                <tr class="bg-white dark:bg-gray-800 border-b dark:border-gray-700">
                                    <th scope="row"
                                        class="px-4 py-2 font-medium text-gray-500 dark:text-gray-400 whitespace-nowrap">
                                        Max Campaigns
                                    </th>
                                    <td class="px-4 py-2 text-right text-gray-800 dark:text-gray-200 font-medium">
                                ...
                                <tr class="bg-white dark:bg-gray-800">
                                    <th scope="row"
                                        class="px-4 py-2 font-medium text-gray-500 dark:text-gray-400 whitespace-nowrap rounded-bl-lg">
                                        Max Contacts Per Campaign
                                    </th>
                                    <td
                                        class="px-4 py-2 text-right text-gray-800 dark:text-gray-200 font-medium rounded-br-lg">
