        ...
        <div class="grid sm:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-6">
            ...
            <div
                ...
                <div class="inline-flex justify-center items-center">
                    ...
                    <span class="text-xs font-semibold uppercase text-gray-600 dark:text-neutral-400">Agents</span>
                </div>
                ...
                <dl class="flex justify-center items-center divide-x divide-gray-200 dark:divide-neutral-800">
                    ...
                    <dd class="text-start ps-3">
                        <span class="text-sm font-semibold text-gray-800 dark:text-neutral-200">{{ rand(3, 10) }}</span>
            ...
            <div
                ...
                <div class="inline-flex justify-center items-center">
                    ...
                    <span class="text-xs font-semibold uppercase text-gray-600 dark:text-neutral-400">Providers</span>
                </div>
                ...
                <dl class="flex justify-center items-center divide-x divide-gray-200 dark:divide-neutral-800">
                    ...
                    <dd class="text-start ps-3">
                        <span class="text-sm font-semibold text-gray-800 dark:text-neutral-200">{{ rand(2, 5) }}</span>
                        <span class="block text-sm text-gray-500 dark:text-neutral-500">last week</span>
                    </dd>
                </dl>
            </div>
            ...
            <div
                ...
                <div class="inline-flex justify-center items-center">
                    ...
                    <span class="text-xs font-semibold uppercase text-gray-600 dark:text-neutral-400">Campaigns</span>
                </div>
                ...
                <dl class="flex justify-center items-center divide-x divide-gray-200 dark:divide-neutral-800">
                    ...
                    <dd class="text-start ps-3">
                        <span class="text-sm font-semibold text-gray-800 dark:text-neutral-200">{{ rand(2, 8) }}</span>
                        <span class="block text-sm text-gray-500 dark:text-neutral-500">last week</span>
                    </dd>
                </dl>
            </div>
