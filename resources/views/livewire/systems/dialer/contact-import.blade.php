    ...
    <div class="fixed inset-0 bg-black/50 z-50 flex items-center justify-center">
        <div class="bg-white p-6 rounded-lg shadow-lg">
            <div class="py-6 border-t border-gray-200 dark:border-neutral-700">
                        ...
                        <div class="flex flex-col items-center justify-center text-center">
                            ...
                            <div class="text-sm text-gray-500 dark:text-gray-400">
                                <p x-show="!fileName && !isUploading && !$wire.isProcessing">
                                    CSV file should contain phone_number, provider_name, provider_extension, start_time, end_time
                                </p>
                ...
                <div class="mt-4">
                    <button wire:click="processCSV" type="button" class="py-1.5 px-3 inline-flex items-center justify-center gap-x-1.5 text-sm font-medium rounded-md border border-gray-300 bg-white text-gray-700 shadow-sm hover:bg-gray-50 dark:bg-neutral-800 dark:text-neutral-200 dark:border-neutral-700 dark:hover:bg-neutral-700"
                ...
                <div 
                    x-data="{ show: false }" 
                    x-show="show" 
                    x-init="$on('import-completed', () => { show = true; setTimeout(() => { show = false }, 5000); })"
