            ...
            <form wire:submit.prevent="createEmployee">
                <div class="py-6 first:pt-0 last:pb-0 border-t first:border-transparent border-gray-200 dark:border-neutral-700 dark:first:border-transparent">
                    <div class="space-y-4">
                        <!-- Employee Name -->
                        <div>
                            <label for="EmplyeeName" class="block text-sm font-medium text-gray-700 dark:text-neutral-300">
                                Employee Name
                            </label>
                            <input type="text" id="EmplyeeName" wire:model="EmplyeeName"
                            ...
                            @error('EmplyeeName') <p class="mt-1 text-sm text-red-600">{{ $message }}</p> @enderror
                        </div>
